...
describe('Binder test', () => {
  ...
  it('Should deep bind properties even with values that converts to false (except null and undefined)', function () {

    var car = ModelFactory.car;
    var data = { model: 'BMW M3', year: 1988, engine: { cylinders: 0, displacement: undefined, output: { power: null, torque: 177 } } };
    ...
    car.model.should.eql('BMW M3');
    car.year.should.eql(1988);
    car.engine.cylinders.should.eql(0);
    car.engine.cylinders.should.eql(0);
    car.engine.output.power.should.eql(0);
  });
